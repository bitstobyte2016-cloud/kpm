                        ...
                        <div class="mega-menu-content">
                            <div class="mega-menu-list">
                                <ul class="bands-grid-list">
                                    <li><a href="#"><img src="https://placehold.co/40x40/B57BE8/FFF?text=BTS" class="band-icon" alt=""> BTS</a></li>
                                    <li><a href="#"><img src="https://placehold.co/40x40/000/FFF?text=ATZ" class="band-icon" alt=""> ATEEZ</a></li>
                                    <li><a href="#"><img src="https://placehold.co/40x40/FFF/000?text=SKZ" class="band-icon" alt=""> Stray Kids</a></li>
                                    <li><a href="#"><img src="https://placehold.co/40x40/1a2b4c/FFF?text=EN" class="band-icon" alt=""> ENHYPEN</a></li>
                                    <li><a href="#"><img src="https://placehold.co/40x40/000/f4a7bb?text=BP" class="band-icon" alt=""> BLACKPINK</a></li>
                                    <li><a href="#"><img src="https://placehold.co/40x40/a2b9e6/FFF?text=TXT" class="band-icon" alt=""> TXT</a></li>
                                    <li><a href="#"><img src="https://placehold.co/40x40/94bfe6/FFF?text=SVT" class="band-icon" alt=""> SEVENTEEN</a></li>
                                    <li><a href="#"><img src="https://placehold.co/40x40/a0c85a/FFF?text=NCT" class="band-icon" alt=""> NCT</a></li>
